...
file_list <- list.files("scenario_reverse")
...
for(i in 1:length(file_list)){
  ...
  all <- readRDS(paste0("scenario_reverse/", file_list[i]))
...
write.csv(all_res_df, "main_res_reverse.csv", row.names = FALSE)
write.csv(prey_min_mat, "prey_min_mat_reverse.csv", row.names = FALSE)
write.csv(pred_min_mat, "pred_min_mat_reverse.csv", row.names = FALSE)
write.csv(prey_max_mat, "prey_max_mat_reverse.csv", row.names = FALSE)
write.csv(pred_max_mat, "pred_max_mat_reverse.csv", row.names = FALSE)
